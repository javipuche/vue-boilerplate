...
export default class Header {
    ...
    bindNavigationLinkEvents () {
        ...
        if (navigationLink.length) {
            navigationLink.forEach((link) => link.addEventListener('mouseover', this.toggleNavigation.bind(this)))
        }
    }
    ...
    selectDefaultNavigation (element) {
        const secondChild = element.querySelector(`${this.selectors.navigationLink}:first-child`)
